...
Equation:
\[
    \begin{cases}y^2&=a_1x^2+b_1x+c_1,\\z^2&=a_2x^2+b_2x+c_2\end{cases}
\]
...
Interconnections: this entry is grouped with the `quadratic-forms-conics` family. Current triage clusters: conics, intersections_of_quadrics, quadratic_forms.
