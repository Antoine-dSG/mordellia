...
The entry is a quartic-surface rational-point problem, often diagonal or built from quadratic forms.

Mordell records this entry on pp.~116--117. The blueprint statement status is `statement`.
